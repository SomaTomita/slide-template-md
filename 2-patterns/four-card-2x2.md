...
**Category:** Cards & grids  ·  **Use case:** Hybrid

## What it is
A grid of cards, each a small headline + supporting line.

## Reference content (swap in your own)
- **Kicker / label:** Overview
- **Title (action title):** Four key points
- **In the body:** 01, Speed, Ship value in days, not months., 02, Quality, Crafted to last and easy to maintain., 03, Trust, Built on transparency and security., 04, Care, People and support come first.
...
Layout — four-card-2x2: a grid of cards, each a small headline + supporting line.
...
- Body: 01, Speed, Ship value in days, not months., 02, Quality, Crafted to last and easy to maintain., 03, Trust, Built on transparency and security., 04, Care, People and support come first.
